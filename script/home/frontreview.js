function front_review (album_name, album_link, artist_name, artist_link, album_art, release_year, genres, rating_img, reviewer, reviewer_link, body) {
	return $("<div/>").html($.parseHTML(`
